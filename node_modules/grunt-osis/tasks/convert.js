    ...
    if (srcExt === '.xml') {
        ...
        parse(srcFiles, options, function(err, result) {
          ...
          if (destExt === '.md') {
            ...
            var bibleURL = '/'+biblePath.replace('data/bibles/gh-pages/translation/','');
            ...
            if(language[languageID].hasTranslation){
              if(!language[languageID].used){
                ...
                languageData += '\n- ['+language[languageID].title+'](/'+languageID+')';
              }
              grunt.file.write('data/bibles/gh-pages/translation/' + languageID + destExt, language[languageID].data);
            }
            grunt.file.write( 'data/bibles/gh-pages/language' + destExt, languageData);
            finish();
            next();
          }else{
